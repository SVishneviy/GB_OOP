...
import org.example.exceptions.InvalidReservationNumberException;
import org.example.exceptions.InvalidTableNumberException;
...
public class TableService implements Model {
    ...
    public int reservationTable(Date reservationDate, int tableNo, String name) {
        ...
        throw new InvalidTableNumberException("Некорректный номер столика");
    }
